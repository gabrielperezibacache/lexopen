...
async function main() {
  ...
  const causa1 = await prisma.causa.create({
    data: {
      ...
      pjudLastSyncNote: "Lista para sync demo o partner API.",
      pjudExternalKey: "C-4521-2025|1º Juzgado Civil de Santiago",
        ...
        create: [
          {
            ...
            fuente: "manual",
            tipo: "resolucion",
            referencia: "C-4521-2025-R1",
            relevante: true,
            fecha: new Date("2025-03-20T12:00:00"),
          },
          {
            ...
            fuente: "manual",
            tipo: "escrito",
            referencia: "C-4521-2025-E1",
            relevante: false,
            fecha: new Date("2025-04-10T12:00:00"),
          },
        ],
      },
    },
